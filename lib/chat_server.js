...
var allConversations = [{"members": ["jacksonmeister", "logangster"],
			"messageList": [{type: 'text', author: "jacksonmeister", data: { text: "Why don't they have salsa on the table?"} },
                      ...
                      {"members": ["kelpaso", "logangster"],
                      			"messageList": [{type: 'text', author: "kelpaso", data: { text: "I love my little pony!"} },
                                            {type: 'text', author: "logangster", data: { text: "Dude I'm sick of hearing about that game"} },
                                            {type: 'text', author: "kelpaso", data: { text: "It's the best though!"} },
                                            {"members": ["jacksonmeister", "kelpaso"],
                                            			"messageList": [{type: 'text', author: "jacksonmeister", data: { text: "Dude how about My Little Pony?"} },
                                                                  {type: 'text', author: "kelpaso", data: { text: "I'm a brony for life!"} },
                                                                  {type: 'text', author: "jacksonmeister", data: { text: "Yeah me too dude."} }]
    }];
